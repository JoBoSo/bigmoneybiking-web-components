    ...
    events: [
      {
        ...
        description:
          "Highway 23 North crosses the Goldstream River on the way to Sprauge Bay.",
        photos: [
          {
...

      {
        header: "Sprauge Bay",
        description:
          "I camped at Sprauge Bay Recreation Site where I explored the shore of Kinbasket Lake. There's a short trail through the forest that takes you to a view point overlooking the lake where you can access the rocky, sandy shore.",
        photos: [
          {
...

      {
        header: "Mica Dam",
        description:
          "Mica Dam is the tallest dam in Canada and second tallest in North America after the Chicoasén Dam in Mexico and it is the farthest upstream dam on the Columbia River. The road beyond the dam is a logging road that leads to Sprauge Bay.",
        photos: [
          {
    ...
    events: [
      {
        header: "",
        description:
          "I hiked the Perley Rock Trail in Glacier National Park (Canada). The trail took me to the edge of the massive Illecillewaet Glacier.",
        photos: [
          {
    ...
    events: [
      {
        header: "",
        description:
          "I biked up Meadows in the Sky Parkway in Mt. Revelstoke National Park and hiked the Jade Lakes Trail at the top of the mountain.",
        photos: [
          {
    ...
    events: [
      {
        header: "",
        description:
          "I biked up Meadows in the Sky Parkway in Mt. Revelstoke National Park and hiked out to Miller Lake from the parking lot at the top.",
        photos: [
          {
    ...
    events: [
      {
        header: "My House",
        description:
          "I lived beneath Mt. Grassi. There were trails and forests behind my house and great views from my basement apartment.",
        photos: [
          {
...

      {
        ...
        description:
          "I hiked and biked in Canmore, Banff, and Lake Louise in the fall and skiied at Sunshine Village. Some of the captions can be clicked to see more.",
        photos: [
          {
          ...
          },
          {
            ...
            caption:
              "<a href='../hikes/ha-ling.html' style='color: white;'>Ha Ling</a>",
          },
          {
            image: "canmore/IMG_1124.jpg",
            caption:
              "<a href='../hikes/cory-pass.html' style='color: white;'>Cory Pass</a>",
          },
          {
            image: "canmore/IMG_1171.jpg",
            caption:
              "<a href='../hikes/bourgeau.html' style='color: white;'>Mt. Bourgeau</a>",
          },
          {
            image: "canmore/IMG_1222.jpg",
            caption:
              "<a href='../hikes/mt-temple.html' style='color: white;'>Mt. Temple</a>",
          },
          {
            image: "canmore/IMG_1324.jpg",
            caption:
              "<a href='../hikes/grotto-mtn.html' style='color: white;'>Grotto Mountain</a>",
          },
          {
...

      {
        header: "Christmas",
        description:
          "My family came to Canmore for Christmas. Andrew and I went skiing in Fern-dog after the ladies left, but his fragile Ontario thighs quivered beneath the strength of the deep pow. Can you blame the boy? He's only ever known two dimensions of space and a light sprinkling.",
        photos: [
          {
    ...
    events: [
      {
        header: "The Cottage",
        description:
          "I found this cottage on AirBnb. The roof leaked when it poured rain and it had mice and spiders in it, but who can complain for $800 a month? The region has insects like no other--horse flies, mosquitos, caterpillers, ants, beatles, and everything else. There were a few heavy storms where it poured and hailed. It got very humid on hot days with all of the rivers and lakes around.",
        photos: [
          {
...

      {
        ...
        description:
          "I biked on the narrow, winding roads and paths through green forests. Parc Eco Laurentides was a short ride away from my cottage and it had a trail around a lake and up a mountain.",
        photos: [
          {
...

      {
        header: "Old Friends",
        description:
          "I was grateful to have my friends come all the way up here to do some biking and hiking with me.",
        photos: [
          {
...

      {
        ...
        description:
          "I went on a couple of hikes and a bike tour of the P'tit Train Du Nord while living here. Click the captions to read about these adventures.",
        photos: [
          {
            image: "mont-blanc/IMG_2312.jpg",
            caption:
              "<a href='../hikes/mont-nixon.html' style='color: white;'>Mont Nixon</a>",
          },
          {
            image: "mont-blanc/IMG_2361.jpg",
            caption:
              "<a href='../hikes/montagne-noire.html' style='color: white;'>Montagne Noire</a>",
          },
          {
            image: "mont-blanc/IMG_2546.jpg",
            caption:
              "<a href='../tours/ptit-train.html' style='color: white;'>P'tit Train Du Nord</a>",
          },
        ],
      },
    ],
  ...
  calgary: {
    ...
    events: [
...

      {
        ...
        description:
          "Shots from the path around Glenmore Reservoir on the edge of Calgary.",
        photos: [
          {
...

      {
        ...
        description:
          "Bragg creek has some of the nearest mountain trails for biking, hiking, and skiing.",
        photos: [
          {
...

      {
        header: "Out & About",
        description:
          "Here are some more shots I took whilst puttering around Calgary in search of love.",
        photos: [
          {
    ...
    events: [
      {
        ...
        description:
          "We brought the extremely overgrown Cronin Creek Trail back to life.",
        photos: [
          {
...

      {
        ...
        description:
          "We cleaned the Joe L'Orsa Cabin in Silver King Basin and recieved a load of logs from a helicopter.",
        photos: [
          {
...

      {
        ...
        description:
          "We built a long boardwalk across a flood plain between the lake and a marsh.",
        photos: [
          {
...

      {
        ...
        description:
          "We replaced the boards on the docks at the ranger cabin in Tweedsmuir North Provincial Park and boated to campsites in the park to do maintenance.",
        photos: [
          {
...

      {
        ...
        description:
          "We cut back overgrowth on the Francois Lake Trail in Uncha Mountain Red Hills Provincial Park and built a boardwalk by spliting a fallen tree.",
        photos: [
          {
...

      {
        ...
        description:
          "We cleared overgrowth and fallen trees from the Harvey Mountain Trail and hiked to the top.",
        photos: [
          {
...

      {
        ...
        description:
          "We patrolled the Babine River during the salmon run to make sure fisherman were staying with in the catch limits and being bear-safe.",
        photos: [
          {
  ...
  revelstoke: {
    ...
    events: [
...

      {
        ...
        description:
          "Hikes I went on in Revelstoke. Click the captions see more.",
        photos: [
          {
            image: "revelstoke/hiking/IMG_8022.jpg",
            caption:
              "<a href='../hikes/mt-begbie.html' style='color: white;'>Mt. Begbie</a>",
          },
          {
            image: "revelstoke/hiking/IMG_8111.jpg",
            caption:
              "<a href='../hikes/mt-cartier.html' style='color: white;'>Mt. Cartier</a>",
          },
          {
            image: "revelstoke/hiking/IMG_8309.jpg",
            caption:
              "<a href='../hikes/mccrae-peak.html' style='color: white;'>McCrae Peak</a>",
          },
        ],
      },
    ],
    ...
    events: [
      {
        ...
        description:
          "Our trip to Denman Island on August 10-14, 2020 to restore Taylor's Checkerspot Butterfly habitat by removing invasive Scotch Broom from their breeding grounds in Denman Island Park.",
        photos: [
          {
...

      {
        ...
        description:
          "Our trip to Helliwell Provincial Park on Hornby Island on July 2, 2020 to take pictures for the BC Parks iNaturalist Project.",
        photos: [
          {
...

      {
        header: "Yorke Island",
        description:
          "Our trip to the overgrown WWII military base on Yorke Island on July 2, 2020 to clear fallen trees along the old road.",
        photos: [
          {
...

      {
        ...
        description:
          "Our trip to Landslide Lake on July 15-16, 2020 to divert water away from the Elk River Trail.",
        photos: [
          {
...

      {
        header: "Marble River",
        description:
          "Our trip to Marble River on July 21-24, 2020 to rebuild a bridge on the trail.",
        photos: [
          {
...

      {
        header: "Echo Bay",
        description:
          "Our trip to Echo Bay on August 5-7, 2020 to repaint the signs and clear fallen trees.",
        photos: [
          {
...

      {
        ...
        description:
          "Our trip to Jedediah Island on August 11-14, 2020 to remove debris left over from a cabin fire.",
        photos: [
          {
...

      {
        ...
        description:
          "Our trip to Mitlenatch Island on August 17-18, 2020 to remove invasive Himalayan Blackberry.",
        photos: [
          {
...

      {
        ...
        description:
          "Our trip to San Josef Bay on August 25-27, 2020 to remove invasive English Ivy from the edge of the beach.",
        photos: [
          {
