...
const timelines = {
  bourgeau: [
    {
      header: "Sunrising",
      description:
        "The sun began to reach the mountain when I arrived at Bourgeau Lake, which is close to the treeline.",
      left_image: null,
    ...
    },
    {
      header: "The Ridge",
      description:
        "You can see that the lake is surrounded by the steep ridge that leads to the peak.",
    ...
    },
    {
      ...
      description:
        "Beyond the treeline, a pond sits above the lake that it overflows in to.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "Another pond lies in Harvey Pass, above Lake Bourgeau and beneath the long ridge that leads to the peak.",
    ...
    },
    {
      header: "Harvey Pass",
      description:
        "There were high-resolution views of the rocky mountain-sides in Harvey Pass.",
      left_image: null,
    ...
    },
    {
      header: "Peak",
      description:
        "You can see other mountain ranges and the town of Banff from the top.",
      left_image: null,
    ...
    },
    {
      header: "Looking Down",
      description:
        "Looking down from the peak, you can see the ponds, lake, and green, neighbouring mountains.",
  ...
  "montagne-noire": [
    {
      ...
      description:
        "Mont Noire is next to Lac Archambault. St. Donat is at the other end of the lake.",
      left_image: null,
    ...
    },
    {
      header: "Lac Lézard",
      description:
        "There are two lakes on the hike and this is the first one I passed.",
    ...
    },
    {
      ...
      description:
        "A military airplane, called The Liberator, crashed on the mountain, killing 24 soldiers.",
      left_image: null,
    ...
    },
    {
      header: "Memorial",
      description:
        "There is a memorial site for the soldiers with a lookout tower.",
    ...
    },
    {
      ...
      description:
        "The view from the memorial lookout. Theres a much bigger lookout tower at the peak.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The lookout tower at the peak has views of green mountains.",
  ...
  "mt-temple": [
    {
      ...
      description:
        "After hiking up through the forest from Moraine Lake, you enter the Valley of The Ten Peaks.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The view of The Ten Peaks mountains from the top of The Pass.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The view opposite The Ten Peaks Mountains from the top of The Pass.",
    ...
    },
    {
      ...
      description:
        "This hungry man was on the mountain. He was clawing at my backpack.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The mountains store their surplus magic in colorful ponds, like this one.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "If Beyoncé's closet was at the top of Mt. Temple and I were her ex-boyfriend, I would own everything in this picture and it would all be in a box, believe it or not.",
    ...
    },
    {
      ...
      description:
        "Now, everything you see here, to the right, would belong to Beyoncé. So, I would have to leave it all behind, unfortunately. What a shame considering this view is absolutely irreplacable.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "Morraine Lake is a Rocky Mountain icon that's worth seeing from the heavens.",
      left_image: null,
    ...
    },
    {
      header: "Bumps",
      description:
        "From the top, it is clear just how bumpy the landscape is out here. This province needs to invest in better roads.",
    ...
    },
    {
      header: "Eiffel Peak",
      description:
        "Named after the Eiffel Tower in Paris, France for its similarly triangular contour.",
      left_image: null,
    ...
    },
    {
      header: "Mountainside",
      description:
        "I was shocked to see how much the mountainside had crumbled on my way back down because I'm not even that heavy.",
    ...
    },
    {
      ...
      description:
        "Given that Mt. Temple is in the Rocky Mountains, the trail features a number of rocks.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "At this point, the peak was just a distant memory of a time gone by. I was well on my way back to the parking lot where I would have no choice but to seek refuge in my home on the slope of Mt. Grassi for the night.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "You've seen it from above, but now you're seeing it from below. A different elevation, a different story. You decide which one is right, which is wrong.",
    ...
    },
    {
      ...
      description:
        "I would gladly eat this view for dinner if it were on the menu.",
      left_image: null,
  ...
  "mont-nixon": [
    {
      header: "Viewpoint #1",
      description:
        "You can see these mountains with bulbous green tops from the first viewpoint.",
      left_image: null,
    ...
    },
    {
      header: "Mont Nixon",
      description:
        "This is still at viewpoint #1. The granite cliffs belong to Mont Nixon, which is where the trail leads.",
    ...
    },
    {
      header: "The Big View",
      description:
        "All of the viewpoints are nice--I think there are four or five of them--but this is the bigget view along the trail.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The last viewpoint provides the best shot of a granite cliff on Mont Nixon.",
  ...
  "six-glaciers": [
    ...
    },
    {
      ...
      description:
        "I hiked past the teahouse and up a ridge on The Plain. This is the view looking back at Lake Louise.",
  ...
  "grotto-mtn": [
    ...
    },
    {
      header: "Fossils",
      description:
        "The rocks are fascinating. There is bright orange moses growing on the dense, hard rocks and fossils.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "You can look back at Canmore from just about every where on the trail.",
    ...
    },
    {
      ...
      description:
        "You can see past the eastern-most mountains to the praries and the Calgary skyline from the top.",
      left_image: null,
  ...
  "cory-pass": [
    {
      ...
      description:
        "The dry pine forests east of Lake Louise can be so warm, quiet, and peaceful.",
      left_image: null,
  ...
  "ha-ling": [
    {
      header: "Miner's Peak",
      description:
        "After hiking up the super busy trail, I first went up Miner's Peak--the one in the foreground.",
      left_image: null,
    ...
    },
    {
      header: "Ha Ling",
      description:
        "Next, I dipped down and up Ha Ling. Looking closely, you can the mass of little people standing at the top.",
    ...
    },
    {
      header: "Canmore",
      description:
        "Of course, you have views of Canmore and the Bow Valley from the top.",
      left_image: null,
  ...
  "seaton-ridge": [
    {
      ...
      description:
        "Student Ranger Javier and I walked through young forests and cut blocks.",
      left_image: null,
    ...
    },
    {
      header: "To The Top",
      description:
        "We stood on the peak to look upon the land. There was lots of mountain goat hair and we did see some goats below.",
      left_image: null,
    ...
    },
    {
      header: "Grey v. Green",
      description:
        "The land was many shades of green at war with the grey, falling rock.",
    ...
    },
    {
      header: "Back Down",
      description:
        "We walked back down the spine and continued to take in the big views.",
      left_image: null,
  ...
  "maroon-mtn": [
    {
      header: "Tall Trees",
      description:
        "The trailhead is at the end of a tight, bumpy gravel road. You immediately cross a foot-bridge and then walk through a tall forest.",
      left_image: null,
  ...
  "silvern-lake": [
    {
      header: "Two Looks",
      description:
        "The snow was deep on May 24th. By July 1st, the trail was dry.",
    ...
    },
    {
      ...
      description:
        "Three mountains surround this cozy and lively plateau. I saw more wildlife and flowers here than on any other hike in 2021.",
    ...
    },
    {
      ...
      description:
        "This is the first lake along the trail. You can see three white specs in the meadow across the lake if you zoom into this photo. They are mountain goats. There was a whole herd of them moving around the lake, grazing.",
    ...
    },
    {
      header: "Silvern Lake",
      description:
        "Past the first lake and around a bend, sits Silvern Lake. I saw a beaver building his dam, seen to the right-side of the lake in this photo, and a grizzly bear and cub at the left shore that I had hiked from a few minutes later.",
      left_image: null,
    ...
    },
    {
      header: "Wildflowers",
      description:
        "Wildflowers in full-bloom lined the marshy lake. Bees were floating from flower to flower.",
    ...
    },
    {
      ...
      description:
        "I camped on a flat part of the ridge next to this colourful mountain-side, which belongs to Hudson Bay Mountain.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "This is the big view from colourful mountain-side location where I took the previous photo.",
    ...
    },
    {
      header: "Jagged Peak",
      description:
        "That pointy, jagged peak in the center of this photo is one of the coolest peaks in the Bulkley Valley. You can see it wide and far, from town and the trails. It has some dark magic.",
      left_image: null,
  ...
  gunsight: [
    {
      header: "Creek",
      description:
        "Snow melting off the top of the mountain created a fast-flowing creek through the bushy coastal forest.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "A side-trail leads to what's left of an abandoned, overgrown fish hatchery.",
      left_image: null,
  ...
  "mccrae-peak": [
    {
      ...
      description:
        "I biked from Revelstoke to the trailhead. Akolkolex Falls is on the road toward McCrae Peak. A series of waterfalls flow through deep canyons that lead to the Columbia River.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The trailhead is near the top of the mountain. The ride up the steep, rocky logging road was the hard work of the day. The views of the Columbia Valley were big the whole way up.",
    ...
    },
    {
      header: "The Trail",
      description:
        "The hike begins near the treeline. Near the start, I passed a couple loads of fresh, purple bear shit in the short section through the forest, which led to McCrae Lake Rec Site and then the mossy plateau shown in this photo.",
      left_image: null,
    ...
    },
    {
      header: "",
      description:
        "The section of the trail up to the peak was tough. It followed a ridge across snow and jagged rock.",
    ...
    },
    {
      header: "",
      description:
        "This final section to the peak was a scramble up steep, loose-rock. It really freaked me out.",
      left_image: null,
    ...
    },
    {
      header: "",
      description:
        "After the tough scramble, a plateau leads gently to the peak. I saw this merry band of fluffy birds on top of the mountain. I have never seen birds like this before.",
    ...
    },
    {
      header: "",
      description:
        "The views of the Columbia Valley from the peak were glorious. Sun beams shot through the clouds. It was late in the afternoon and the sun had set by the time I was back on my bike.",
  ...
  "mt-cartier": [
    ...
    },
    {
      ...
      description:
        "Once out of the forest, switchbacks cross the steep, sunny slope.",
    ...
    },
    {
      ...
      description:
        "Wealthier men than I heli to the top and mountain bike down. If I didn't know any better, I, too, might believe money can't buy happiness.",
    ...
    },
    {
      header: "Dusk",
      description:
        "I biked home from the base at dusk. Don't let the rest of them fool you. <i>This</i> is paradise.",
  ...
  "mt-revelstoke": [
    {
      ...
      description:
        "I biked over to the park on the edge of town and hiked up to Monashee Lookout.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "I continued up the winding Lindmark Trail, which had snow on it at higher elevations.",
    ...
    },
    {
      header: "Bear Prints",
      description:
        "There were bear prints in the snow on the trail. It took me a long time before I noticed that they were bear prints, and not from other hikers, because the prints had melted into big round imprints at lower elevations. I was thinking, 'damn, this hiker has some big feet'.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "There were some massive mushrooms bursting through the earth.",
      left_image: null,
    ...
    },
    {
      header: "Dank AF",
      description:
        "If this shroom were cheese it would be some expensive stuff.",
    ...
    },
    {
      header: "Bodybuilder",
      description:
        "This one had a thick neck from headbutting it's way through the ground.",
    ...
    },
    {
      header: "The Lagoon",
      description:
        "This is the fertile shroom lagoon. I could have easily missed it but for the gentle whispers of it's inhabitants.",
      left_image: null,
    ...
    },
    {
      header: "Revelstoke",
      description:
        "After a thorough exploration of the shroom lagoon, I came back down to beautiful Revelstoke. I could sleep easy knowing the diverse mushroom kingdom was alive and well on Mt. Revelstoke.",
  ...
  "silver-king": [
    {
      ...
      description:
        "Babine Mountains Provincial Park is on the edge of Smithers, where I worked as a Student Ranger. I went up to Silver King Basin twice, once to clean and stock the Joe L'Orsa Cabin and once by bike on my own time.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "The Silver King Basin feeds the thrist of hikers, bikers, and rangers, alike.",
    ...
    },
    {
      ...
      description:
        "Some Rangers stocking some fire wood for the campers and cabiners.",
      left_image: null,
    ...
    },
    {
      header: "Campground",
      description:
        "A campground with horse stalls caters to horse lovers and cowboys.",
    ...
    },
    {
      ...
      description:
        "If you can get your hands on $10 you can sleep in the cabin.",
      left_image: null,
  ...
  "mt-becher": [
    {
      header: "Cabin In The Woods",
      description:
        "I passed this little cabin on one of the bike trails that led to the Mt. Becher trailhead from Courtenay.",
      left_image: null,
    ...
    },
    {
      header: "Comox Lake",
      description:
        "Imagine paragliding across that lake, from one mountain to another.",
    ...
    },
    {
      ...
      description:
        "I took the Boston Ridge route up and the Mt. Becher Trail down. Boston Ridge had better views.",
