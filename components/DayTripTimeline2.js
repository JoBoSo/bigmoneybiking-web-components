  ...
  "mt-temple": [
    {
      header: "Peaks",
      description:
        "After hiking up from Moraine Lake, there's a clear view of the mountains near the treeline.",
      left_image: null,
    ...
    },
    {
      header: "Mt. Temple",
      description:
        "The destination comes into view as you approach Sentinel Pass.",
    ...
    },
    {
      header: "Treeline",
      description:
        "Theres a plateau at the top of the treeline, just before the ascent.",
      left_image: null,
    ...
    },
    {
      ...
      description:
        "Looking back on the trail from the top of the pass. Similarly grand views sit to the other side.",
